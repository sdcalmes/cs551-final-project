...
add wave -noupdate -format Logic -radix hexadecimal /proc_hier_pbench/DUT/p0/ex_branch
add wave -noupdate -format Logic -radix hexadecimal /proc_hier_pbench/DUT/p0/ex_branch_eqz
...
add wave -noupdate -format Logic -radix hexadecimal /proc_hier_pbench/DUT/p0/flop_stall
...
WaveRestoreCursors {{Cursor 1} {2336 ns} 0}
WaveRestoreZoom {0 ns} {10468 ns}
