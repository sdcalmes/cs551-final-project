...
set my_verilog_files [list add_16.v alu_control.v alu.v branch_control.v cache.v cla4.v control.v decode.v dff.v execute.v ex_mem.v fetch.v final_memory.syn.v forwarding.v four_bank_mem.v id_ex.v if_id.v memc.syn.v memory2c_align.syn.v memory2c.syn.v memory.v mem_system.v memv.syn.v mem_wb.v pc_inc.v proc.v reg_16.v reg_1.v rf_bypass.v rf.v shift1.v shift2.v shift4.v shift8.v shifter.v stallmem.syn.v  ]
